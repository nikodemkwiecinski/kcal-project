...
const LoginPanel: React.FC<BlurProps> = ({userLoged, setIsUserLoged, blurToogle, setBlurToogle}) => {
  ...
  return (
    <section className={`${blurToogle ? 'fixed' : 'hidden'} rounded-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1/3 2xl:h-half xl:h-7/10 lg:h-8/10 bg-light-white z-50`}>
